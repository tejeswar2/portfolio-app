    ...
    <nav className='navbar'>
        ...
        <button   className='desktopContactBtn'  onClick={()=>{
          document.getElementById('contact').scrollIntoView({behavior:'smooth'});
            ...
            <img src={contactImg} alt='' className='desktopContactImg'/>contact Me
        </button>
        ...
        <div className='navMenu' style={{display: showMenu? 'flex':'none'}}>
            ...
            {/* <Link activeClass='active' to='clients' spy={true} smooth={true} offset={-50} duration={500} className='listItem' onClick={()=>setshowMenu(false)}>Resume</Link> */}
